...
def seguir_programa():
    while True:
        resp = input('¿Desea continuar el con el programa?')
        print(resp.upper())
        if resp.upper() == 'SI':
...
'''6. - Escriba un programa que pregunte una y otra vez si desea terminar el programa, siempre que se conteste exactamente N(en mayúsculas).'''
